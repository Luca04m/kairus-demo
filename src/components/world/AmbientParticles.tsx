...
const DOMAIN_CHARS: Record<DepartmentId, string[]> = {
  vendas:      ['$', '\u25C6', '\u25B2'],
  marketing:   ['\u2726', '\u2666', '\u25C7'],
  financeiro:  ['0', '1', '\u2B21'],
  operacoes:   ['\u2699', '\u25CE', '\u2B22'],
    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 1 }}>
      {particles.map((p) => (
        <motion.div
          ...
          style={{ left: p.x, top: p.y, fontSize: p.size, color: d.tileColor, fontFamily: 'monospace' }}
          animate={{ x: [0, p.driftX, 0], y: [0, p.driftY, 0], opacity: [0, p.opacity, 0], scale: [0.5, 1, 0.5] }}
