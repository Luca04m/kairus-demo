...
// Ported from aiox-dashboard, adapted for Kairus OS domains
...
export function agentSpriteRects(domainColors: SpriteColors, identity?: AgentIdentity): SpriteRect[] {
  ...
  switch (id.bodyPattern) {
    ...
    case 'tshirt':
      rects.push({ x: 4, y: 6, w: 8, h: 5, fill: bodyBase });
      rects.push({ x: 6, y: 6, w: 4, h: 2, fill: accent, opacity: 0.4 });
      break;
    case 'hoodie':
      rects.push({ x: 4, y: 6, w: 8, h: 5, fill: bodyBase });
      rects.push({ x: 6, y: 5, w: 4, h: 2, fill: bodyBase });
      rects.push({ x: 6, y: 8, w: 4, h: 2, fill: bodyDark });
      break;
    case 'lab':
      rects.push({ x: 4, y: 6, w: 8, h: 5, fill: '#F5F6FA' });
      rects.push({ x: 6, y: 6, w: 4, h: 5, fill: bodyBase });
      rects.push({ x: 4, y: 6, w: 2, h: 5, fill: '#F5F6FA' });
      rects.push({ x: 10, y: 6, w: 2, h: 5, fill: '#F5F6FA' });
      break;
  }
  ...
  switch (id.accessory) {
    case 'glasses':
      ...
      rects.push({ x: 8, y: 3, w: 1, h: 0.5, fill: '#636E72' });
      break;
    case 'headphones':
      rects.push({ x: 4, y: 1, w: 1, h: 3, fill: '#636E72' });
      rects.push({ x: 11, y: 1, w: 1, h: 3, fill: '#636E72' });
      rects.push({ x: 5, y: 0, w: 6, h: 1, fill: '#636E72' });
      break;
    case 'hat':
      rects.push({ x: 4, y: -1, w: 8, h: 2, fill: accent });
      rects.push({ x: 3, y: 1, w: 10, h: 1, fill: accent });
      break;
    case 'scarf':
      rects.push({ x: 4, y: 5, w: 8, h: 2, fill: accent });
      rects.push({ x: 4, y: 7, w: 2, h: 2, fill: accent });
      break;
    case 'bowtie':
      rects.push({ x: 6, y: 6, w: 1, h: 1, fill: accent });
      rects.push({ x: 7, y: 6, w: 2, h: 1, fill: '#2D3436' });
    ...
    case 'bandana':
      ...
      rects.push({ x: 11, y: 1, w: 2, h: 2, fill: accent });
      break;
    case 'none':
      break;
  }
